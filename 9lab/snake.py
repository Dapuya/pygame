...
while run:
    ...
    if snake1.score > 8 and (curr - seconds_of_level_2_for_R[0]) > 8000:
        snake1.is_level_2 = True

    if snake1.score == 17:
        seconds_of_level_3_for_R.append(pygame.time.get_ticks())

    if snake1.score > 16 and (curr - seconds_of_level_3_for_R[0]) > 8000:
        snake1.is_level_3 = True

    if snake2.score == 9:
        seconds_of_level_2_for_B.append(pygame.time.get_ticks())

    if snake2.score > 8 and (curr - seconds_of_level_2_for_B[0]) > 8000:
        snake2.is_level_2 = True

    if snake2.score == 17:
        seconds_of_level_3_for_B.append(pygame.time.get_ticks())

    if snake2.score > 16 and (curr - seconds_of_level_3_for_B[0]) > 8000:
