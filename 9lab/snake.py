...
class Snake:
    ...
    def draw(self):
        for elem in self.elements:
            pygame.draw.circle(screen, (0, 0, 0), elem, self.radius)
...
def show_score():
    show = font1.render('Score of 1: ' + str(snake1.score), True, (0, 0, 0))
    show2 = font1.render('Score of 2: ' + str(snake2.score), True, (0, 0, 0))
    screen.blit(show, (35, 30))
    screen.blit(show2, (410, 30))


def show_level():
    show_level_1 = font_for_levels.render('Level of 1: ' + str(snake1.level), True, (0, 0, 0))
    show_level_2 = font_for_levels.render('Level of 2: ' + str(snake2.level), True, (0, 0, 0))
...
def game_over():
    with open('scores.txt', 'a') as f:
        f.write('\nScore of 1: ' + str(snake1.score) + '\nLevel of 1: ' + str(snake1.level))
        f.write('\nScore of 2: ' + str(snake2.score) + '\nLevel of 2: ' + str(snake2.level))
        f.close()

    screen.fill((255, 255, 255))
    over = font2.render("GAME OVER!", True, (0, 0, 0))
    score_1 = font1.render('Score of 1: ' + str(snake1.score), True, (0, 0, 0))
    score_2 = font1.render('Score of 2: ' + str(snake2.score), True, (0, 0, 0))
    level_1 = font_for_levels.render('Level of 1: ' + str(snake1.level), True, (0, 0, 0))
    level_2 = font_for_levels.render('Level of 2: ' + str(snake2.level), True, (0, 0, 0))
